...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1872.3336995244447; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1724.0930405800405; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2179.450940866483; // x position of the perpendicular encoder (in tick units)
    }
