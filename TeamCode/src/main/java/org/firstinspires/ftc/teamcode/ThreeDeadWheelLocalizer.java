...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2032.066266907333; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2501.2220662455766; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1410.1172275288448; // x position of the perpendicular encoder (in tick units)
    }
